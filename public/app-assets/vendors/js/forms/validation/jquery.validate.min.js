...
!function (a) {
    ...
    a.extend(a.expr.pseudos || a.expr[":"], {
        ...
        messages: {
            ...
            maxlength: a.validator.format("Veuillez ne pas saisir plus de {0} caractères."),
            minlength: a.validator.format("Veuillez saisir au moins {0} caractères."),
            rangelength: a.validator.format("Please enter a value between {0} and {1} characters long."),
            range: a.validator.format("Please enter a value between {0} and {1}."),
            max: a.validator.format("Veuillez entrer une valeur inférieure ou égale à {0}."),
            min: a.validator.format("Veuillez saisir une valeur supérieure ou égale à {0}."),
            step: a.validator.format("Veuillez entrer un multiple de {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
